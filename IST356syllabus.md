...
```
   ...
   Office Hours:  M/W noon-2PM in 323E Hinds Hall or via Zoom by appointment

   Teaching Asssistants:
   Noah Bamberger ...   Email: ntbamber@syr.edu
   Kailee Peterson ...  Email: kgpeters@syr.edu
...
All required readings are available publicly online, and in many cases, the online sources are the most up-to-date references to the relevant course material. See reading list section for additional details. 
...
You are expected to attend and participate in every class session. If you must miss class, you will be responsible for making up the work and catching up on what was missed. Do expect instructor support if you miss class. Consider reaching out to a classmate to share notes from class.
...
We will review the homework assignment. Students will be asked to contribute to the discussion.
...
- Good reflection: specific, uses terminology, actionable, lessons learned.
- Handed in on time.

### Exams

Exams are summative assessments. They are designed to test your knowledge of the material.  The exams will be issued in class on the dates posted on the course schedule. Exams are closed-book but you may bring one double sides 8.5x11 sheet of paper with your notes. Exams length is 90 minutes. There will be a mix of mix of multiple choice, short answer and code tracing and code writing.
...
- The pipeline should incorporate techniques we learned in the course. The more techniques you incorporate correctly the higher your grade.
- It is expected that you will be able to explain your choices, and they will be appropriate for the problem.
- The pipeline should be first written as exploratory, and then refactored into a production quality pipeline. Both pipelines should be submitted.
- There should be a simple data visualization or dashboard from the pipeline output as to demonstrate its usefulness as well as analysis of findings.

## Grading

| Assessment | Type | Learning Outcomes | Quantity | Points Each | Points Percent |
|------------|------|-------------------|----------|-------------|--------------|
| Attendance/Activities | Formative | 1, 2 | 15 | 1 | 15 |
